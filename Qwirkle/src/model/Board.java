...
//	}
	...
	/*@ requires getBlock(move) instanceof Block;
	  ...
	  @ ensures ((\forall int i; (\forall int j; 0 <= j & j < i; 
		...
		getField(getX(move) + i, getY(move)).getColor() != getBlock(move).getColor() &&
		!(getField(getX(move) + i, getY(move)).getShape() != getBlock(move).getShape()) ||
		!(getField(getX(move) + i, getY(move)).getColor() != getBlock(move).getColor()) &&
		getField(getX(move) + i, getY(move)).getShape() != getBlock(move).getShape() ||
	...
	/*@ requires getBlock(move) instanceof Block;
	  ...
	  @ ensures ((\forall int i; (\forall int j; 0 <= j & j < i; 
		...
		getField(getX(move), getY(move) + i).getColor() != getBlock(move).getColor() &&
		!(getField(getX(move), getY(move) + i).getShape() != getBlock(move).getShape()) ||
		!(getField(getX(move), getY(move) + i).getColor() != getBlock(move).getColor()) &&
		getField(getX(move), getY(move) + i).getShape() != getBlock(move).getShape() ||
